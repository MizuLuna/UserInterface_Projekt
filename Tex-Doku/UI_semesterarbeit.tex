...
\begin{document} 						% Beginn des Dokumentes
	...
	% Hauptteil
	%-----------------------------------------------------------------------------
%\footnote{\label{foot:1}mobiler Fotostudioaufbau}
%(vgl. Abbildung \ref{ist})
%Kapitel \textit{\ref{viewcontroller} \nameref{viewcontroller}} 
% „“
\newpage
...
\begin{figure}[h]
	...
	\end{figure} \\
	\\
	In der Render-Funktion  (vgl. Abbildung \ref{render-methode}) werden alle Ansichten über ihre Tags eingebunden und anhand der 'route' Variable, welche den Namen der aktuell aufgerufenen Seite enthält, ein- und ausgeblendet.\\	
	\begin{figure}[h]
		\centering
